...
function createRemoteTempFolder() {
    return ssh.execCommand(
      "rm -rf riot-riot-express-todo-list-temp && mkdir riot-riot-express-todo-list-temp",
      {
        cwd: "/home/ubuntu"
      }
    );
...
function updateRemoteApp() {
    return ssh.execCommand(
        'cp -r riot-riot-express-todo-list-temp/* riot-riot-express-todo-list/ && rm -rf riot-riot-express-todo-list-temp', {
            cwd: '/home/ubuntu'
        });
}
...
function restartRemoteServices() {
    return ssh.execCommand(
        'cd riot-riot-express-todo-list && sudo service mongod start && pm2 start app.js', {
            cwd: '/home/ubuntu'
        });
}
